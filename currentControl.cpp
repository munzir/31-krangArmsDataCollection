...
void init () {
	...
	if(rightArm) dopt.ident = "00-rlwa";
	else dopt.ident = "00-llwa";
	somatic_d_init( &daemon_cx, &dopt );

	// Initialize the arm
	if(rightArm) initArm(daemon_cx, singlearm, "rlwa");
	else initArm(daemon_cx, singlearm, "llwa");
...
int main(int argc, char* argv[]) {
	...
	if(argc != 3) {
		cout << "Usage: ./currentControl <test|train> <rightArm|leftArm>" << endl;
		return 0;
	}

	else if(!strcmp(argv[1], "train")) {
		train = true;
		if(!strcmp(argv[2], "rightArm")) rightArm = true;
		else if(!strcmp(argv[2], "leftArm")) rightArm = false;
		else { cout << "Please specify a third argument (rightArm|leftArm)" << endl; return 0; }	}
	...
	if(train) {
		if(rightArm) {
			dataQ.open("../rightArm/trainData/dataQ.txt");
			dataDotQ.open("../rightArm/trainData/dataDotQ_NF.txt");
			dataCur.open("../rightArm/trainData/dataCur.txt");
			dataTimeStamp.open("../rightArm/trainData/dataTimeStamp.txt");
			dataQref.open("../rightArm/trainData/dataQref.txt");
			dataDQref.open("../rightArm/trainData/dataDQref.txt");
		}
		else {
			dataQ.open("../leftArm/trainData/dataQ.txt");
			dataDotQ.open("../leftArm/trainData/dataDotQ_NF.txt");
			dataCur.open("../leftArm/trainData/dataCur.txt");
			dataTimeStamp.open("../leftArm/trainData/dataTimeStamp.txt");
			dataQref.open("../leftArm/trainData/dataQref.txt");
			dataDQref.open("../leftArm/trainData/dataDQref.txt");
		}
	}
	else{
		if(rightArm) {
			dataQ.open("../rightArm/testData/dataQ.txt");
			dataDotQ.open("../rightArm/testData/dataDotQ_NF.txt");
			dataCur.open("../rightArm/testData/dataCur.txt");
			dataTimeStamp.open("../rightArm/testData/dataTimeStamp.txt");
			dataQref.open("../rightArm/testData/dataQref.txt");
			dataDQref.open("../rightArm/testData/dataDQref.txt");
		}
		else {
			dataQ.open("../leftArm/testData/dataQ.txt");
			dataDotQ.open("../leftArm/testData/dataDotQ_NF.txt");
			dataCur.open("../leftArm/testData/dataCur.txt");
			dataTimeStamp.open("../leftArm/testData/dataTimeStamp.txt");
			dataQref.open("../leftArm/testData/dataQref.txt");
			dataDQref.open("../leftArm/testData/dataDQref.txt");
		}
	}
